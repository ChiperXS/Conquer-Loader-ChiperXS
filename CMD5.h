...
#define FF(a, b, c, d, x, s, ac) { \
	(a) += __F((b), (c), (d)) + (x)+(UINT4)(ac); \
	(a) = ROTATE_LEFT((a), (s)); \
	(a) += (b); \
}
#define GG(a, b, c, d, x, s, ac) { \
	(a) += __G((b), (c), (d)) + (x)+(UINT4)(ac); \
	(a) = ROTATE_LEFT((a), (s)); \
	(a) += (b); \
	}
#define HH(a, b, c, d, x, s, ac) { \
	(a) += __H((b), (c), (d)) + (x)+(UINT4)(ac); \
	(a) = ROTATE_LEFT((a), (s)); \
	(a) += (b); \
	}
#define II(a, b, c, d, x, s, ac) { \
	(a) += __I((b), (c), (d)) + (x)+(UINT4)(ac); \
	(a) = ROTATE_LEFT((a), (s)); \
	(a) += (b); \
	}
#pragma endregion
...
namespace API {
	...
	private:
		...
		static VOID Encode(BYTE * Output, UINT4 * Input, uint32_t Len) {
			uint32_t i, j;
		...
		static VOID Decode(UINT4 * Output, BYTE * Input, uint32_t Len) {
			uint32_t i, j;
			for (i = 0, j = 0; j < Len; i++, j += 4)
	...
	public:
		...
		VOID UpDate(BYTE * Input, uint32_t InputLen) {
